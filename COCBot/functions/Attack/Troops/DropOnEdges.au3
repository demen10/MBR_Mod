...
Func DropOnEdges($troop, $nbSides, $number, $slotsPerEdge = 0)
	...
	; Classic FourFingers attack - Demen_FF_#9007
	If $nbSides = 5 Then
	...
	For $i = 0 To $nbSides - 1
		...
		If $nbSides = 1 Or ($nbSides = 3 And $i = 2) Then
			...
			If $g_iMatchMode = $LB And $g_aiAttackStdDropSides[$LB] >= 5 Then ; Used for DE or TH side attack  ; FourFingers - Demen_FF_#9007
